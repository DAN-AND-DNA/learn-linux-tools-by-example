...
利用该工具可以追踪进程的系统调用，例如:
    ...
    $ strace -T -ttt -p 4863
    strace: Process 4863 attached
    1557980690.094349 epoll_wait(4, [{EPOLLIN, {u32=3, u64=3}}], 10000, 10000) = 1 <2.926908>
    1557980693.021310 accept4(3, {sa_family=AF_INET, sin_port=htons(55858), sin_addr=inet_addr("192.168.0.45")}, [16], SOCK_CLOEXEC|SOCK_NONBLOCK) = 6 <0.000012>
    1557980693.021360 write(1, "1557980693 client online :192.16"..., 39) = 39 <0.000011>
    1557980693.021389 epoll_ctl(4, EPOLL_CTL_ADD, 6, {EPOLLIN, {u32=6, u64=5630027437233405958}}) = 0 <0.000008>
    1557980693.021413 epoll_wait(4, [{EPOLLIN, {u32=6, u64=5630027437233405958}}], 10000, 10000) = 1 <0.000008>
    1557980693.021435 read(6, "a", 1)       = 1 <0.000009>
    1557980693.021459 epoll_wait(4, [{EPOLLIN, {u32=6, u64=5630027437233405958}}], 10000, 10000) = 1 <1.006827>
    1557980694.028329 read(6, "a", 1)       = 1 <0.000016>
    1557980694.028364 epoll_wait(4, [{EPOLLIN, {u32=6, u64=5630027437233405958}}], 10000, 10000) = 1 <1.061431>
    1557980695.089865 read(6, "a", 1)       = 1 <0.000027>
    1557980695.089955 epoll_wait(4, [{EPOLLIN, {u32=6, u64=5630027437233405958}}], 10000, 10000) = 1 <1.000368>
    1557980696.090368 read(6, "a", 1)       = 1 <0.000010>
    1557980696.090399 epoll_wait(4, [{EPOLLIN, {u32=6, u64=5630027437233405958}}], 10000, 10000) = 1 <1.000272>
    1557980697.090721 read(6, "a", 1)       = 1 <0.000009>
    1557980697.090744 epoll_wait(4, [{EPOLLIN, {u32=6, u64=5630027437233405958}}], 10000, 10000) = 1 <0.738838>
    1557980697.829642 read(6, "", 1)        = 0 <0.000008>
    1557980697.829695 write(1, "1557980697 client offline\n", 26) = 26 <0.000012>
    1557980697.829731 epoll_ctl(4, EPOLL_CTL_DEL, 6, 0x7fff4e21e0b0) = 0 <0.000008>
    1557980697.829771 close(6)              = 0 <0.000044>
    1557980697.829829 epoll_wait(4, [], 10000, 10000) = 0 <10.011406>
    1557980707.841269 epoll_wait(4, 
...
查看总体的统计，需要目标进程结束:
    ...
    ------ ----------- ----------- --------- --------- ----------------
    50.57    0.000442          29        15         1 epoll_wait
    27.23    0.000238          18        13           read
    16.13    0.000141          71         2           close
    3.66    0.000032           8         4           write
    1.14    0.000010           5         2           epoll_ctl
    0.69    0.000006           6         1           accept4
    0.46    0.000004           4         1           munmap
    0.11    0.000001           1         1         1 rt_sigreturn
    ------ ----------- ----------- --------- --------- ----------------
    100.00    0.000874                    39         2 total
    
其他详细参数请参考[man strace]()
## valgrind
